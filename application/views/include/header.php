...
<head>
        ...
        <!-- Title -->
        <title><?php echo $this->session->userdata("clinic_name"); ?></title>
        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo base_url();?>apanel/index.jsp" class="logo-text"><span><?php echo $this->session->userdata("clinic_name");?></span></a>
                    </div><!-- Logo Box -->
